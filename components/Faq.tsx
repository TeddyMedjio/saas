  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem className="border-b border-[#ffffff60]" value="item-1">
        <AccordionTrigger
          className="text-white text-base md:text-xl font-bold"
          font-inter
        >
          How does the pricing work for teams
        </AccordionTrigger>
        <AccordionContent className="text-purple-100 text-sm font-inter">
      ...
      <AccordionItem
        className="border-b border-[#ffffff60]"
        value="item-2 font-inter"
      >
      ...
      <AccordionItem
        className="border-b border-[#ffffff60]"
        value="item-3 font-inter"
      >
        <AccordionTrigger className="text-white text-base md:text-xl font-bold font-inter">
          How does the pricing work for teams
        </AccordionTrigger>
        <AccordionContent className="text-purple-100 text-sm font-inter">
